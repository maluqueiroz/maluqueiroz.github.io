...
function showCrew(json) {
  ...
  document.querySelector('.featurette-divider').innerHTML = '';
  window.scrollTo({
    behavior: "smooth",
    top: innerHeight
  });
...
function showSeasons(json) {
  ...
  var addSeasons = document.querySelector('.featurette-divider');
  window.scrollTo({
    behavior: "smooth",
    top: innerHeight
  });
  ...
  try {
    var _loop = function _loop() {
      ...
      var whatToAdd = "<div class=\"row featurette\">\n      <div class=\"col-md-7\">\n        <h2 class=\"featurette-heading\">".concat(season.name, "<span class=\"text-muted\"></span></h2>\n        <p class=\"lead\">").concat(season.overview, "</p>\n      </div>\n      <div class=\"col-md-5\">\n        <img class=\"bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto\" width=\"500\" height=\"500\" src=''>\n      </div>\n      <p class=\"lead\" id=\"seta\"> Epis\xF3dios <i class=\"fas fa-angle-down\"></i></p>\n    </div> "); // count++

      season.name == "Specials" ? '' : addSeasons.insertAdjacentHTML('beforeend', whatToAdd);
      ...
      try {
        for (var _iterator5 = setas[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          var seta = _step5.value;
          seta.addEventListener('click', function (e) {
            fetch(urlGetEpisodes).then(function (res) {
              return res.json();
            }).then(function (json) {
              return showEpisodes(json);
            });
          });
        }
      } catch (err) {
...
function showEpisodes(json) {
  var whereToAdd = document.querySelectorAll('.fas');
  ...
  try {
    for (var _iterator6 = episodes[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      var episode = _step6.value;
      var whatToAdd = "<div>\n    <h2>".concat(episode.episode_number, ": ").concat(episode.name, "</h2>\n    <h4>Review: ").concat(episode.vote_average, "</h4>\n    <p>").concat(episode.overview, "</p>\n    </div>");
      whereToAdd.insertAdjacentHTML('beforeend', whatToAdd);
    }
  } catch (err) {
...
},{}],"../../AppData/Roaming/npm-cache/_npx/9000/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "18112" + '/');
...
},{}]},{},["../../AppData/Roaming/npm-cache/_npx/9000/node_modules/parcel/src/builtins/hmr-runtime.js","js/main.js"], null)
